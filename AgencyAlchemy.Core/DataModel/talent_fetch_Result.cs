...
namespace AgencyAlchemy.Core.DataModel
{
    ...
    public partial class talent_fetch_Result
    {
        ...
        public Nullable<int> birthdate_year { get; set; }
        public Nullable<int> birthdate_month { get; set; }
        public Nullable<int> birthdate_day { get; set; }
    }
}
