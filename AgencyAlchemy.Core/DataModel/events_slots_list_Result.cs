...
namespace AgencyAlchemy.Core.DataModel
{
    ...
    public partial class events_slots_list_Result
    {
        ...
        public string eventslots_unique1 { get; set; }
        public Nullable<int> unbooked { get; set; }
        public Nullable<byte> user_slot_status { get; set; }
        public Nullable<int> user_slot { get; set; }
    }
}
