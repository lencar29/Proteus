...
namespace AgencyAlchemy.Core.DataModel
{
    ...
    public partial class agency_talent_list_qs_Result
    {
        ...
        public Nullable<int> peoplemetrics_people_fk { get; set; }
        public Nullable<int> peoplemetrics_metric_fk { get; set; }
        public Nullable<System.DateTime> peoplemetrics_created { get; set; }
        public Nullable<bool> peoplemetrics_is_featured { get; set; }
        public Nullable<int> peoplemetrics_pk { get; set; }
        public Nullable<int> peoplemetrics_agency_fk { get; set; }
        public Nullable<int> metric_pk { get; set; }
        public Nullable<int> metric_category_fk { get; set; }
        public string metric_title { get; set; }
        public Nullable<System.DateTime> metric_created { get; set; }
        public Nullable<int> metric_ordinal { get; set; }
        public Nullable<bool> metric_is_rated { get; set; }
        public string metric_lineage { get; set; }
        public string people_unique1 { get; set; }
