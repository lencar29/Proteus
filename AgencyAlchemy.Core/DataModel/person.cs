...
namespace AgencyAlchemy.Core.DataModel
{
    ...
    public partial class person
    {
        public person()
        {
            ...
            this.metrics_custom = new HashSet<metrics_custom>();
            this.notes = new HashSet<note>();
            this.people_locations = new HashSet<people_locations>();
            this.people_metrics = new HashSet<people_metrics>();
            this.people_rating = new HashSet<people_rating>();
            this.people_rating1 = new HashSet<people_rating>();
            this.private_notes = new HashSet<private_notes>();
        ...
        public virtual ICollection<metrics_custom> metrics_custom { get; set; }
        public virtual ICollection<note> notes { get; set; }
        public virtual ICollection<people_locations> people_locations { get; set; }
        public virtual ICollection<people_metrics> people_metrics { get; set; }
        public virtual ICollection<people_rating> people_rating { get; set; }
        public virtual ICollection<people_rating> people_rating1 { get; set; }
        public virtual ICollection<private_notes> private_notes { get; set; }
